                    ...
                    <form method='POST' onSubmit={handleProductsData} autoComplete='off' >
                        <div className='card-body'>
                            ...
                            <div className='grid grid-cols-2 md:grid-cols-3 gap-4'>
                                ...
                                <InputTag spanText="Total Page" inputType="text" required={true} inputName="sizeVariation" changeHandle={(e) => setProductDetails((prev) => ({ ...prev, sizeVariation: e.target.value, }),)} inputValue={productDetails.sizeVariation} />

                                {/* <InputTag spanText="sizeVariation" inputType="text" required={true} inputName="sizevariation" changeHandle={(e) => setProductDetails((prev) => ({ ...prev, sizevariation: e.target.value, }),)} inputValue={productDetails.sizevariation} /> */}
                                <InputTag spanText="Seller"      inputType="text" required={true} inputName="seller" changeHandle={(e) => setProductDetails((prev) => ({ ...prev, seller: e.target.value, }),)} inputValue={productDetails.seller} />
