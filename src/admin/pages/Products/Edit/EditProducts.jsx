                    ...
                    <form method='POST' onSubmit={handleProductsData} autoComplete='off' >
                        <div className='card-body'>
                            ...
                            <div className='grid grid-cols-2 md:grid-cols-3 gap-4'>
                                ...
                                <InputTag spanText="Total Pages" inputType="text" required={true} inputName="sizeVariation" changeHandle={(e) => setProductDetails((prev) => ({ ...prev, sizeVariation: e.target.value, }),)} inputValue={productDetails.sizeVariation} />
